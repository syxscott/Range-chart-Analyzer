...
class RangeChartApp:
    ...
    def _build_ui(self):
        ...
        body.columnconfigure(0, weight=0, minsize=600)
    ...
    def _build_left(self, parent):
        ...
        self.btn_add_prov = self._reg(
            ttk.Button(title_row, text="", style="Primary.TButton",
        ...
        self.lbl_maxtok.grid(row=0, column=0, sticky="w", padx=4, pady=2)
        self.ent_maxtok = ttk.Entry(adv_frame, textvariable=self.var_maxtok, width=10)
        self.ent_maxtok.grid(row=0, column=1, sticky="w", padx=4, pady=2)

        self.lbl_runs = self._reg(ttk.Label(adv_frame, text="", style="Muted.TLabel"),
                                  "text", "settings.runs")
        self.lbl_runs.grid(row=0, column=2, sticky="w", padx=12, pady=2)
        self.ent_runs = ttk.Spinbox(adv_frame, from_=1, to=5, textvariable=self.var_runs, width=6)
        self.ent_runs.grid(row=0, column=3, sticky="w", padx=4, pady=2)

        self.lbl_maxedge = self._reg(ttk.Label(adv_frame, text="", style="Muted.TLabel"),
                                     "text", "settings.maxEdge")
        self.lbl_maxedge.grid(row=1, column=0, sticky="w", padx=4, pady=2)
        self.ent_maxedge = ttk.Entry(adv_frame, textvariable=self.var_maxedge, width=10)
        self.ent_maxedge.grid(row=1, column=1, sticky="w", padx=4, pady=2)
        ...
        self.lbl_chart_type.grid(row=2, column=0, sticky="w", padx=4, pady=2)
        ...
        self.cmb_chart_type.grid(row=2, column=1, sticky="w", padx=4, pady=2)
        ...
        self.lbl_chartlang.grid(row=2, column=2, sticky="w", padx=12, pady=2)
        ...
        self.cmb_chartlang.grid(row=2, column=3, sticky="w", padx=4, pady=2)
        ...
        self.btn_save = self._reg(ttk.Button(btn_row, text="", style="Primary.TButton",
        ...
        self.btn_choose = self._reg(ttk.Button(img_btn_row, text="", style="Primary.TButton",
                                    command=self._choose_image), "text", "image.choose")
        self.btn_choose.pack(side="left", fill="x", expand=True, padx=(0, 6))
        self.btn_paste = self._reg(ttk.Button(img_btn_row, text="", style="Primary.TButton",
    ...
    def _refresh_active_panel(self):
        ...
        btn = self._reg(ttk.Button(test_row, text="", style="Primary.TButton",
