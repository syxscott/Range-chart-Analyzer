...
const RCA_I18N = {
  ...
  'settings.enhance.hint': '对薄延长线和小字号标注启用 3× 上采样 + 去噪，提升识别率（会增加传输时间）。',
    ...
    'results.autoDetected': '自动识别：',
    'results.viaVision': '视觉',
    'results.autoChipHint': '图表类型由自动识别决定（图注关键词或视觉分类），悬停查看模式详情',
    'upload.chartMode.chemicalStratigraphy': '地球化学图式',
    'upload.chartMode.paleomap': '古地理图',
    'upload.chartMode.scatterPlot': '散点图',
...
RCA_I18N.en = {
  ...
  'upload.chartMode.phylogeneticTree': 'Phylogenetic tree',
    'results.autoDetected': 'Auto-detected: ',
    'results.viaVision': 'vision',
    'results.autoChipHint': 'Chart type decided by auto-detection (caption keywords or vision classification)',
    'upload.chartMode.chemicalStratigraphy': 'Chemical stratigraphy',
    'upload.chartMode.paleomap': 'Paleomap',
    'upload.chartMode.scatterPlot': 'Scatter plot',
...
RCA_I18N.ja = {
  ...
  'upload.chartMode.phylogeneticTree': '系統樹',
    'results.autoDetected': '自動判別：',
    'results.viaVision': '画像判定',
    'results.autoChipHint': '図表タイプは自動判別（キャプション or 画像分類）',
    'upload.chartMode.chemicalStratigraphy': '地質化学図式',
    'upload.chartMode.paleomap': '古地図',
    'upload.chartMode.scatterPlot': '散布図',
